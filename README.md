...
| --- | --- | --- | --- |
| **FSRS-6** | **0.36±0.076** | **0.05±0.011** | **0.69±0.056** |
| FSRS-5 | 0.37±0.084 | 0.06±0.021 | 0.68±0.061 |
| FSRS-4.5 | 0.37±0.089 | 0.06±0.023 | 0.68±0.060 |
| FSRSv4 | 0.38±0.088 | 0.06±0.024 | 0.67±0.061 |
| AVG | 0.38±0.069 | 0.08±0.017 | 0.08±0.017 |
| FSRSv3 | 0.40±0.092 | 0.08±0.020 | 0.65±0.049 |
| SM-17 | 0.41±0.097 | 0.08±0.020 | 0.62±0.038 |
...
| Algorithm | Log Loss↓ | RMSE (bins)↓ | AUC↑ |
| --- | --- | --- | --- |
| **FSRS-6** | **0.40±0.067** | **0.07±0.023** | **0.65±0.047** |
| AVG | 0.41±0.076 | 0.09±0.025 | 0.09±0.025 |
| FSRS-5 | 0.43±0.076 | 0.10±0.036 | 0.64±0.048 |
| FSRS-4.5 | 0.43±0.091 | 0.10±0.036 | 0.64±0.047 |
| FSRSv4 | 0.45±0.087 | 0.11±0.049 | 0.63±0.049 |
| FSRSv3 | 0.50±0.11 | 0.12±0.039 | 0.62±0.043 |
| SM-17 | 0.50±0.12 | 0.10±0.034 | 0.63±0.035 |
| SM-16 | 0.50±0.11 | 0.12±0.034 | 0.61±0.024 |
