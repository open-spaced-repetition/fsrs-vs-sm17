...
| --- | --- | --- | --- |
| **FSRS-6** | **0.362±0.078** | **0.050±0.014** | **0.679±0.059** |
| FSRS-5 | 0.381±0.085 | 0.074±0.023 | 0.667±0.060 |
| FSRS-4.5 | 0.381±0.084 | 0.074±0.023 | 0.666±0.060 |
| AVG | 0.387±0.073 | 0.086±0.017 | 0.531±0.026 |
| FSRSv4 | 0.401±0.091 | 0.093±0.030 | 0.656±0.060 |
| SM-17 | 0.414±0.097 | 0.083±0.020 | 0.622±0.038 |
| SM-16 | 0.421±0.087 | 0.106±0.026 | 0.599±0.020 |
| FSRSv3 | 0.443±0.120 | 0.109±0.029 | 0.635±0.052 |

### Unweighted (per user)

| Algorithm | Log Loss↓ | RMSE (bins)↓ | AUC↑ |
| --- | --- | --- | --- |
| **FSRS-6** | **0.408±0.067** | **0.081±0.030** | **0.648±0.043** |
| AVG | 0.423±0.081 | 0.099±0.023 | 0.506±0.032 |
| FSRS-4.5 | 0.434±0.074 | 0.109±0.036 | 0.637±0.042 |
| FSRS-5 | 0.438±0.074 | 0.113±0.039 | 0.636±0.043 |
| SM-17 | 0.466±0.110 | 0.102±0.033 | 0.626±0.035 |
| SM-16 | 0.468±0.110 | 0.124±0.034 | 0.609±0.024 |
| FSRSv4 | 0.478±0.084 | 0.145±0.052 | 0.623±0.044 |
| FSRSv3 | 0.527±0.130 | 0.144±0.045 | 0.611±0.041 |
